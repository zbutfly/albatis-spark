...
//        options.put("subscribe", "ZHK_QBZX_LGZS_NEW");
        ...
        SparkKafkaOutput sparkKafkaOutput = new SparkKafkaOutput(session,uriSpec,TableDesc.dummy("kafkaTest"));


        Map<String, String> options = sparkKafkaOutput.options("test1");
