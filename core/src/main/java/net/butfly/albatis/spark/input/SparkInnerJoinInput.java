...
public class SparkInnerJoinInput extends SparkJoinInput {
	...
	public SparkInnerJoinInput(SparkInput<Rmap> input, String col, SparkInput<Rmap> joined, String joinedCol, String as) {
		super(input, col, joined, joinedCol, "inner", as);
	}
}
